...
def test():
    print("test")
# Tk window object sets the title size using rowconfigure and columconfigure
def main():
    window = tk.Tk()
    ...
    # Text widget on grid layout row 0 and column 1
    text_edit = tk.Text(window, font="Hack 18 italic")
